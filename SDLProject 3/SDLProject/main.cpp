...
void Initialize() {
    ...
    state.platform[0].entityType = PLATFORM; //set this tile to be entityType PLATFORM.

    state.platform[1].textureID = tileTextureID;
    state.platform[1].position = glm::vec3(-1, -3.25f, 0);
    state.platform[1].entityType = PLATFORM; //set this tile to be entityType PLATFORM.

    state.platform[2].textureID = tileTextureID;
    state.platform[2].position = glm::vec3(1, -3.25f, 0);
    state.platform[2].entityType = PLATFORM; //set this tile to be entityType PLATFORM.
    /********************** WIN TILE *************************************/
    ...
    state.platform[3].entityType = PLATFORM2; //set the win tile to be entity type PLATFORM2
    /*********************************************************/
    state.platform[4].textureID = tileTextureID;
    state.platform[4].position = glm::vec3(1, -2.25f, 0);
    state.platform[4].entityType = PLATFORM; //set this tile to be entityType PLATFORM.
    /******************** WIN TILE *************************/
    ...
    state.platform[5].entityType = PLATFORM2; //set the win tile to be entity type PLATFORM2
    /***********************************************************/
    state.platform[6].textureID = tileTextureID;
    state.platform[6].position = glm::vec3(2, -3.25f, 0);
    state.platform[6].entityType = PLATFORM; //set this tile to be entityType PLATFORM.

    state.platform[7].textureID = tileTextureID;
    state.platform[7].position = glm::vec3(5, -3.25f, 0);
    state.platform[7].entityType = PLATFORM; //set this tile to be entityType PLATFORM.

    state.platform[8].textureID = tileTextureID;
    state.platform[8].position = glm::vec3(5, -2.25f, 0);
    state.platform[8].entityType = PLATFORM; //set this tile to be entityType PLATFORM.

    state.platform[9].textureID = tileTextureID;
    state.platform[9].position = glm::vec3(5, -1.25f, 0);
    state.platform[9].entityType = PLATFORM; //set this tile to be entityType PLATFORM.

    state.platform[10].textureID = tileTextureID;
    state.platform[10].position = glm::vec3(5, -.25f, 0);
    state.platform[10].entityType = PLATFORM; //set this tile to be entityType PLATFORM.

    state.platform[11].textureID = tileTextureID;
    state.platform[11].position = glm::vec3(5, 0.75f, 0);
    state.platform[11].entityType = PLATFORM; //set this tile to be entityType PLATFORM.

    state.platform[12].textureID = tileTextureID;
    state.platform[12].position = glm::vec3(5, 1.75f, 0);
    state.platform[12].entityType = PLATFORM; //set this tile to be entityType PLATFORM.

    state.platform[13].textureID = tileTextureID;
    state.platform[13].position = glm::vec3(5, 2.75f, 0);
    state.platform[13].entityType = PLATFORM; //set this tile to be entityType PLATFORM.

    state.platform[14].textureID = tileTextureID;
    state.platform[14].position = glm::vec3(5, 3.75f, 0);
    state.platform[14].entityType = PLATFORM; //set this tile to be entityType PLATFORM.
    /****************set rest of tiles to be entityType PLATFORM.***************************************/
    for (int i = 15; i < 28; i++) {
        state.platform[i].entityType = PLATFORM;
    } //I used a for loop to set their entityType real fast.
